...
nperm = 10 #about 1 minute for 100 permutations for 3 species
nrep = 2
n_species <- 2
...
res_prop_b30_df <- list_rbind(res_prop_b30) %>%
  mutate(prop1_bin = trunc(prop_biomass_sp1/0.05,0)*0.05)
...
```{r}
load("output_data/simdat2spp100rep100perm_propvar_b30_20250820.Rdat")

res_prop_b30_df %>%
  summarize(mean(total_biomass_sp1), mean(total_biomass_sp2), sd(total_biomass_sp1), sd(total_biomass_sp2))
...
res_prop_b30_df %>%
  add_row(
    ...
    res_prop_b30_df %>%
      mutate(prop1_bin = trunc(prop_biomass_sp2/0.05,0)*0.05) %>%
      mutate(p_sp1 = p_sp2) %>%
      filter(prop1_bin < 0.5)
  ) %>%
