...
res_oe %>%
  ...
  mutate(test = factor(test, levels = c("t_test_sig", "f_test_sig", "glm_mgcv_sig","KS_test_sig","median_test_sig","mvglm_sig", "perma_sig"),
                       ordered = TRUE,
...
power_fig_dat <- 
  ...
  mutate(Test = factor(Test, 
                       levels = c("t_test_sig", "f_test_sig",
                                  ...
                                  "glm_mgcv_sig", "mvglm_sig", "perma_sig", "glmm_sig"),
                       labels = c("t-test", "F test", 
                                  "K-S test", "Median","Permutation", 
                                  "GLM", "pMvGLM", "PERMANOVA", "MvGLM"))) %>%
...
power_plot <- ggplot(power_fig_dat, 
  ...
  # --- LINE LAYER ---
  geom_line(aes(linewidth = Test %in% c("pMvGLM", "PERMANOVA", "MvGLM"))) +
