...
save all but mvglm
```{r}
save(trip_sets, trip_sets_adj, res_g, res_p, res_t, res_tt, file="output_data/allbutmv_b10_set2.Rdata")
```
...
## combine all tests
```{r}
load(file="output_data/mvglmloop_b40_set2.Rdata")
load(file="output_data/allbutmv_b40_set2.Rdata")
...
save(res_comb, file="output_data/alltests_2spp_oe40_cov25_set2.Rdata")
```
