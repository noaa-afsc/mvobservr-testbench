...
perf_plot_dat <- 
  res_comb_tbl %>%
  pivot_longer(cols=c(perma_p, mvglm_p, p_glmm), names_to = "Test", values_to = "p") %>%
  ...
  mutate(Test = factor(Test, levels = c("perma_p", "mvglm_p", "p_glmm"),
                       labels = c("PERMANOVA", "MvGLM perm", "MvGLM")),
         #fix panel titles
