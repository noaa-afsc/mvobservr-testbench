...
n_samples_per_level <- 250        # 250 per set, 500 total
...
## Clean memory to continue
rm(res_g, res_p, res_permute, res_t, res_tt, res_glmm, res_gllvm, res_p_list, 
     res_glmm_lv1, res_gllvm_lv1)
gc()
Sys.sleep(5)
...
## Clean memory to continue
rm(trip_sets, trip_sets_adj, res_m)
gc()

#STOP HERE - RUN remainder locally.
